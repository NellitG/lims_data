...
class SoilSample(models.Model):
    ...
    county = models.CharField(max_length=200, null=True, blank=True, db_index=True)
    ...
    sample_id = models.CharField(max_length=100, null=True, blank=True, db_index=True)
    ...
    date_sample_received = models.DateField(null=True, blank=True)
    ...
    def __str__(self):
        return self.sample_id if self.sample_id else f"Sample {self.id}"